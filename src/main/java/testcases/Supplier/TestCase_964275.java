...
public class TestCase_964275 {

	//Verify Supplier Supervisor can publish supplier (non TP)with ‘Contract Effective Date’.


	@Test()

	public void createSupplierNonTPWithContractEffectiveDate(int iRowNumber, String sDataSheetName) throws Exception {
