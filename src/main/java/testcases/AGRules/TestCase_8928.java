...
//TFS ID_8930:_684218_Cloud: Verify AG and AG effective date on Account termination when AG populated based on TP and Business classification is Acute
//TFS ID_8929:_684217_Cloud: Verify AG and AG effective date on Account termination when AG populated based on TP and Business classification is Alternate site
...
public class TestCase_8928 {
	...
	public void createMember(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//Reactivating the member to verify the Test case TFS ID_8930:_684218_Cloud: Verify AG and AG effective date on Account termination when AG populated based on TP and Business classification is Acute
		//5. Go to Membership and Click on add new membership
		.clickAddNewMembership()
		.selectMembershipType(DataInputProvider.getCellData_ColName(iRowNumber, "membershipProviderType", sDataSheetName))
		...
		//Reactivating the member to verify the TFS ID_8929:_684217_Cloud: Verify AG and AG effective date on Account termination when AG populated based on TP and Business classification is Alternate site
		//5. Go to Membership and Click on add new membership
		.clickAddNewMembership()
		.selectMembershipType(DataInputProvider.getCellData_ColName(iRowNumber, "membershipProviderType", sDataSheetName))
