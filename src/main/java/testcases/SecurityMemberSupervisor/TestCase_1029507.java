...
//TFS ID_1029507:_1029507:Verify Member Supervisor can only view the Program category

public class TestCase_1029507 {
	...
	public void programCategory(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException 
	{
		...
		//verify Add new categories button is not dislpayed
		
		.verifyAddProgramCategoriesNotDisplayed()
		;
	}
