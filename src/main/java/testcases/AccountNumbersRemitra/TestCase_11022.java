...
import utils.DataInputProvider;
 //TFS ID_11022:_629040: Verify whether user should not be able to add same Remitra account number on to two different Member Accounts.

public class TestCase_11022 {
