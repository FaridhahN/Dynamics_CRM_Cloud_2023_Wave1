...
//TFS ID_1081582:_1081582:_Verify Attachment Status Reason field value mapping for Attachment Status =Declined by Member
...
public class TestCase_1081582 {
	...
	public void verifyAttachmentStatusOptions(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		.verifyAttachmentStatusReasonDeclinedByMember()
