...
//TFS ID_1081583:_1081583:_Verify Attachment Status Reason field value mapping for Attachment Status =Denied by Vendor
...
public class TestCase_1081583 {
	...
	public void verifyAttachmentStatusOptions(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		.verifyAttachmentStatusReasonDeniedByVendor()
