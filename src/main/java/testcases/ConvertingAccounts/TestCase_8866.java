...
//*******INVALID SCENARIO******Test Case 4533:Verify if CAMS rule works fine for a main account converted from shipto account


//******** Test Case Invalid

public class TestCase_8866 {
	...
	public void verifyCAMSRule(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//6. Account Name = Any
		.typeAccountName("Subaccount Ship To CAMS Yes ")
