...
//TFS ID_8787:Cloud - Verify TP can be created without providing DP relation date - Manual 
public class TestCase_8787 {

	@Test
	public void test8787(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
