...
//TFS ID_968109:_Verify NONGPO membership is end dated when account has both GPO and NONGPO memberships


public class TestCase_968109 {

	@Test
	public void endGPOMEmbership(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//10.Go to membership and Open the Premier National membership ***** Premier Non GPO membership should be opened 
		.goToMembershipPage(DataInputProvider.getCellData_ColName(iRowNumber, "membershipProvider", sDataSheetName))
		//.doubleClickOnNationalMembership()
