...
public class TestCase_980131 {
	...
	public void premierPromise(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		.verifyErrorMessage(DataInputProvider.getCellData_ColName(iRowNumber, "membershipProviderType", sDataSheetName))

		.clickGoBackandDiscardChanges()

		//open Premier Promier membership
		.doubleClickMembership("Premier Promise")
		//Data reset
