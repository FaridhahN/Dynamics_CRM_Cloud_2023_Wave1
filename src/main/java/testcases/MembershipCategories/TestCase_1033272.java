...
//TFS ID_1033272:_1033272_Verify System tab added in Membership category form

public class TestCase_1033272 {
	...
	public void Datevalidation(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException  {
		...
		//Click System tab 
		.clickSystemTabinCategory()
		
		//Verify Sysem Tab in the category
		.verifySystemInCategory()

		//Click general tab in thmembership Category
		.clickGeneralTabinCategory()
