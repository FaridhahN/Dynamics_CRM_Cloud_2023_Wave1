...
//TFS ID_11049:_827941:Verify Program membership is inherited when dp change from Adventhealth to diff hierarchy scenario 4


public class TestCase_11049 {
...
;
		...
		.createMembership("SURPASS Core", "Program", "SURPASS Core")
		.getMembershipStartDateForEnddate()
	//navigate To General
		.clickGeneralTab()
