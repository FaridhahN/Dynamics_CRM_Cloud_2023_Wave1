...
public class TestCase_828713 {
	...
	public void verifyCAANeedsApprovalBySupplier(int iRowNumber, String sDataSheetName) throws Exception, InterruptedException {
		...
		.clickAddresDetails()
		.fillAddressOnContact((DataInputProvider.getCellData_ColName(iRowNumber, "street1", sDataSheetName)),
				(DataInputProvider.getCellData_ColName(iRowNumber, "city", sDataSheetName)),
				(DataInputProvider.getCellData_ColName(iRowNumber, "zipcode", sDataSheetName)))
		// Save the record
		.clickSave()
		...
		//CAA End Date
		.typeContactRelationshipEndDate("12/16/2023")
